...
export default function Home() {
  ...
  const showNumeric = method === "anyago";
  const showNoClock = method === "anywhen";
  ...
  return (
    <main className="relative flex flex-col items-center justify-center min-h-screen bg-[#0a0a0a] overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col items-center gap-8 w-full max-w-3xl px-6">
        ...
        <div className="w-full rounded-2xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-sm p-5 shadow-[0_0_0_1px_rgba(255,255,255,0.03),0_32px_64px_-12px_rgba(0,0,0,0.8)]">
            ...
            {showNumeric && (
              <>
                ...
                <button
                  ...
                  className={`font-mono cursor-pointer text-base rounded-md px-2 py-1 border transition-colors ${
                    numeric
                      ? "text-violet-400 border-violet-400/30 bg-violet-400/10"
                      : "text-white/25 border-transparent hover:border-white/[0.1] hover:bg-white/[0.06] hover:text-white/50"
                  }`}
                >
          ...
          <div className="mt-4 pt-4 border-t border-white/[0.06] min-h-[3.5rem] flex items-center justify-center">
            {typed ? (
              <p
